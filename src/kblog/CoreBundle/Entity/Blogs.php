...
class Blogs {
    ...
    /**
     * @ORM\OneToMany(targetEntity="BlogImages", inversedBy="blog" )
     * 
     */
    protected $images;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Users", inversedBy="blogs" )
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    protected $user;
    
    /**
     * @ORM\ManyToOne(targetEntity="Categories", inversedBy="blogs" )
     * 
     */
    protected $category;
