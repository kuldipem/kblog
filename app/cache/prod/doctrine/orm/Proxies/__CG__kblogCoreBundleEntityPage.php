 ...
 */
class Page extends \kblog\CoreBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'slug', 'content', 'is_active', 'created_at', 'updated_at', 'categories');
        }
