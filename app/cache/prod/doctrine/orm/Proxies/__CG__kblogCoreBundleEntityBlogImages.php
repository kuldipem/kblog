 ...
 */
class BlogImages extends \kblog\CoreBundle\Entity\BlogImages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'image', 'priority', 'isActive', 'blog', 'created_at', 'updated_at');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlogImages $proxy) {
