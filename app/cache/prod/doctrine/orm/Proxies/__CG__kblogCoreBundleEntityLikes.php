 ...
 */
class Likes extends \kblog\CoreBundle\Entity\Likes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'updated_at', 'created_at', 'blog', 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Likes $proxy) {
