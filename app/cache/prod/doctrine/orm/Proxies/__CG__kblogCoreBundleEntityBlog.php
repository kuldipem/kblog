 ...
 */
class Blog extends \kblog\CoreBundle\Entity\Blog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'slug', 'description', 'tags', 'images', 'comments', 'likes', 'user', 'created_at', 'updated_at', 'category');
        }
