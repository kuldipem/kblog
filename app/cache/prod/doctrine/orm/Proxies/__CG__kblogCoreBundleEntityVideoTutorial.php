 ...
 */
class VideoTutorial extends \kblog\CoreBundle\Entity\VideoTutorial implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'code', 'description', 'tags', 'created_at', 'updated_at', 'category');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VideoTutorial $proxy) {
